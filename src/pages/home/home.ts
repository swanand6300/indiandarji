...
export class HomePage {
  ...
  callNo;
  constructor(public navCtrl: NavController, db: AngularFireDatabase,public toastCtrl: ToastController,public loadingCtrl: LoadingController,private callNumber: CallNumber,public actionSheetCtrl: ActionSheetController) {
    this.loader.present();
    this.itemsRef = db.list("/darji").snapshotChanges()
